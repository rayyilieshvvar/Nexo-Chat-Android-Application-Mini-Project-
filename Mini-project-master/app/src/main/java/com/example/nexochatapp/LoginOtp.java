...
public class LoginOtp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn = findViewById(R.id.login_nextButton);
        progressBar = findViewById(R.id.login_ProgressBar);
        resendOtpTextView = findViewById(R.id.login_resendOtp);
    ...
    void sighIn(PhoneAuthCredential phoneAuthCredential){
            //login and go back to Security
        setInProgress(true);
